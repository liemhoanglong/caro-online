    ...
    if (status === 0) {
        return (
            <Grid container item xs={12} justify='center'>
                <Card elevation={3} className={classes.root} className='paper-custom'>
                    <CardActionArea style={{ padding: 50 }}>
        ...
        return (
            <Grid container item xs={12} justify='center'>
                <Card className={classes.root} className='paper-custom' style={{ padding: 20, width: '80%' }}>
                    <CardActionArea>
